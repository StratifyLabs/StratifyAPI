 ...
 *
 */
template <typename T> class Vector : public api::WorkObject {
public:
  ...
  Vector &erase(Position position, Count count) {
    m_vector.erase(
  ...
  Vector &remove(u32 pos) { return erase(Position(pos), Count(1)); }
