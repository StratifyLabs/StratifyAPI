...
public:
   ...
   *
   */
  Data &copy_contents(const Item &a, size_t size);

  /*!
   * \details Copies the contents of another data object.
   *
   */
  Data &copy_contents(const Item &reference);
   ...
   */
  Data &copy_contents(const Item &a, const CopyContentsOptions &options);
   ...
   *
   */
  Data &append(const Item &reference);
  Data &operator<<(const Item &reference);
