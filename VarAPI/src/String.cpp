...
String &String::erase(const StringView &string_to_erase, size_t position) {
  size_t erase_pos;
...
Vector<String> String::split(const StringView &delimiter) const {
...
size_t String::count(const var::StringView &occurance) const {
  size_t pos = 0;
  u32 item_count = 0;
