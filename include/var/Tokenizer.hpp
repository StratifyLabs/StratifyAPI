...
public:
  ...
  using EncodedString
    = arg::Argument<const var::String &, struct TokenizerEncodedStringTag>;
  using Delimeters
    = arg::Argument<const var::String &, struct TokenizerDelimetersTag>;
  using IgnoreBetween
    = arg::Argument<const var::String &, struct TokenizerIgnoreBetweenTag>;
  ...
  Tokenizer(const var::String &input, const ParseOptions &options);
  ...
  void parse(const var::String &input, const ParseOptions &options);
