 ...
 *
 */
class Appfs : public api::WorkObject, public AppfsFlags {
public:
  class CreateOptions {
  public:
    ...
    const fs::File source() const { return m_source; }
  ...
  using MountPath
    = arg::Argument<const var::String &, struct AppfsMountPathTag>;

  class ConstructOptions {
  public:
    explicit ConstructOptions() : m_mount("/app") {}
  ...
  static u32 overhead() { return sizeof(appfs_file_t); }
