...
private:
	...
	void print_open_object(enum levels level, const char * key) override;
	...
	void print(enum levels level, const char * key, const char * value, bool is_newline = true) override;
