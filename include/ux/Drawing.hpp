...
protected:
  ...
  void draw_base_properties(
    ...
    bitmap.draw_rectangle(region);

    sgfx::Region inside_outline = calculate_region_inside_outline(region);

    bitmap << sgfx::Pen().set_color(theme->background_color());
    bitmap.draw_rectangle(inside_outline);

    sgfx::Region inside_margin = calculate_region_inside_margin(region);

    bitmap << sgfx::Pen().set_color(theme->border_color());
    bitmap.draw_rectangle(inside_margin);

    bitmap << sgfx::Pen().set_color(theme->color());
    bitmap.draw_rectangle(calculate_region_inside_border(region));
  }
