...
public:
	...
	virtual ElementLinked & at(list_attr_u32 i) = 0;
	...
	void draw_item_to_scale(const draw::DrawingScaledAttr & attr, sg_size_t x_offset, list_attr_u32 item);
...
protected:
	...
	list_attr_u32 m_draw_animation_item;
	list_attr_u32 m_draw_animation_offset;
...
public:
	...
	Element * at(list_attr_u32 i){ return m_items + i; }
	list_attr_u32 size() const { return n_items; }
