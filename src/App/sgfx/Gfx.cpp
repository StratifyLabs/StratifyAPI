...
GfxMap::GfxMap(const Bitmap * bitmap){
	data()->rotation = 0;
...
sg_icon_primitive_t Gfx::line(int16_t x1, int16_t y1, int16_t x2, int16_t y2){
...
sg_icon_primitive_t Gfx::circle(int16_t x, int16_t y, uint16_t r){
	sg_icon_primitive_t ret;
	memset(&ret, 0, sizeof(ret));
...
sg_icon_primitive_t Gfx::arc(int16_t x, int16_t y, sg_size_t rx, sg_size_t ry, int16_t start, int16_t stop, int16_t rotation){
	sg_icon_primitive_t ret;
	memset(&ret, 0, sizeof(ret));
	ret.type = SG_ARC | SG_ENABLE_FLAG;
	ret.shift.x = x;
...
sg_icon_primitive_t Gfx::fill(int16_t x1, int16_t y1){
	sg_icon_primitive_t ret;
	memset(&ret, 0, sizeof(ret));
...
void Gfx::draw_remove(Bitmap * bitmap, const GfxMap & map, bool show){
...
void Gfx::draw_ok(Bitmap * bitmap, const GfxMap & map, bool show){
	int total = 2;
	sg_icon_primitive_t objs[total];
	sg_icon_t icon;
	icon.elements = objs;
...
void Gfx::draw_bars(Bitmap * bitmap, const GfxMap & map, bool show){
	int total = 3;
	sg_icon_primitive_t objs[total];
	sg_icon_t icon;
	icon.elements = objs;
...
void Gfx::draw_circle(Bitmap * bitmap, const GfxMap & map, bool show){
	int total = 1;
	sg_icon_primitive_t objs[total];
	sg_icon_t icon;
	icon.elements = objs;
...
void Gfx::draw_circle_fill(Bitmap * bitmap, const GfxMap & map, bool show){
	int total = 2;
	sg_icon_primitive_t objs[total];
	sg_icon_t icon;
	icon.elements = objs;
...
void Gfx::draw_toggle_off(Bitmap * bitmap, const GfxMap & map, bool show){
	int total = 5;
	sg_icon_primitive_t objs[total];
	sg_icon_t icon;
	icon.elements = objs;
...
void Gfx::draw_toggle_on(Bitmap * bitmap, const GfxMap & map, bool show){
	int total = 6;
	sg_icon_primitive_t objs[total];
	sg_icon_t icon;
	icon.elements = objs;
...
void Gfx::draw_power(Bitmap * bitmap, const GfxMap & map, bool show){
	int total = 2;
	sg_icon_primitive_t objs[total];
	sg_icon_t icon;
	icon.elements = objs;
...
void Gfx::draw_chevron(Bitmap * bitmap, const GfxMap & map, bool show){
	int total = 2;
	sg_icon_primitive_t objs[total];
	sg_icon_t icon;
	icon.elements = objs;
...
void Gfx::draw_arrow(Bitmap * bitmap, const GfxMap & map, bool show){
	int total = 3;
	sg_icon_primitive_t objs[total];
	sg_icon_t icon;
	icon.elements = objs;
...
void Gfx::draw_zoom(Bitmap * bitmap, const GfxMap & map, bool show){
	int total = 2;
	sg_icon_primitive_t objs[total];
	sg_icon_t icon;
	icon.elements = objs;
...
void Gfx::draw_reset(Bitmap * bitmap, const GfxMap & map, bool show){
	int total = 3;
	sg_icon_primitive_t objs[total];
	sg_icon_t icon;
	icon.elements = objs;
...
void Gfx::draw_lightning(Bitmap * bitmap, const GfxMap & map, bool show){
	int total = 3;
	sg_icon_primitive_t objs[total];
	sg_icon_t icon;
	icon.elements = objs;
...
void Gfx::draw_play(Bitmap * bitmap, const GfxMap & map, bool show){
	int total = 4;
	sg_icon_primitive_t objs[total];
	sg_icon_t icon;
	icon.elements = objs;
...
void Gfx::draw_pause(Bitmap * bitmap, const GfxMap & map, bool show){
	int total = 2;
	sg_icon_primitive_t objs[total];
	sg_icon_t icon;
	icon.elements = objs;
...
void Gfx::draw_button_bar(Bitmap * bitmap, const GfxMap & map, bool show){
	int total = 7;
	sg_icon_primitive_t objs[total];
	sg_icon_t icon;
	icon.elements = objs;
...
void Gfx::draw_mic(Bitmap * bitmap, const GfxMap & map, bool show){
	int total = 8;
	sg_icon_primitive_t objs[total];
	sg_icon_t icon;
	icon.elements = objs;
...
void Gfx::draw_clock(Bitmap * bitmap, const GfxMap & map, bool show){
	int total = 3;
	sg_icon_primitive_t objs[total];
	sg_icon_t icon;
	icon.elements = objs;
...
void Gfx::draw_heart(Bitmap * bitmap, const GfxMap & map, bool show){
	int total = 5;
	sg_icon_primitive_t objs[total];
	sg_icon_t icon;
	icon.elements = objs;
...
void Gfx::draw_plot(Bitmap * bitmap, const GfxMap & map, bool show){
	int total = 6;
	sg_icon_primitive_t objs[total];
	sg_icon_t icon;
	icon.elements = objs;
...
void Gfx::draw_bike(Bitmap * bitmap, const GfxMap & map, bool show){
	int total = 11;
	sg_icon_primitive_t objs[total];
	sg_icon_t icon;
	icon.elements = objs;
...
void Gfx::draw_mountain(Bitmap * bitmap, const GfxMap & map, bool show){
	int total = 6;
	sg_icon_primitive_t objs[total];
	sg_icon_t icon;
	icon.elements = objs;
...
void Gfx::draw_compass(Bitmap * bitmap, const GfxMap & map, bool show){
	int total = 6;
	sg_icon_primitive_t objs[total];
	sg_icon_t icon;
	icon.elements = objs;
...
void Gfx::draw_compass_outer(Bitmap * bitmap, const GfxMap & map, bool show){
	int total = 9;
	sg_icon_primitive_t objs[total];
	sg_icon_t icon;
	icon.elements = objs;
...
void Gfx::draw_panel(Bitmap * bitmap, const GfxMap & map, bool show){
	int total = 8;
	sg_icon_primitive_t objs[total];
	sg_icon_t icon;
	icon.elements = objs;
...
void Gfx::draw_panel_fill(Bitmap * bitmap, const GfxMap & map, bool show){
	int total = 9;
	sg_icon_primitive_t objs[total];
	sg_icon_t icon;
	icon.elements = objs;
...
void Gfx::draw_sun(Bitmap * bitmap, const GfxMap & map, bool show){
	int total = 9;
	sg_icon_primitive_t objs[total];
	sg_icon_t icon;
	icon.elements = objs;
...
void Gfx::draw_battery(Bitmap * bitmap, const GfxMap & map, bool show){
	int total = 7;
	sg_icon_primitive_t objs[total];
	sg_icon_t icon;
	icon.elements = objs;
...
void Gfx::draw_arrowhead(Bitmap * bitmap, const GfxMap & map, bool show){
	int total = 4;
	sg_icon_primitive_t objs[total];
	sg_icon_t icon;
	icon.elements = objs;
...
void Gfx::draw_dot(Bitmap * bitmap, const GfxMap & map, bool show){
	int total = 1;
	sg_icon_primitive_t objs[total];
	sg_icon_t icon;
	icon.elements = objs;
...
void Gfx::draw_dash(Bitmap * bitmap, const GfxMap & map, bool show){
	int total = 1;
	sg_icon_primitive_t objs[total];
	sg_icon_t icon;
	icon.elements = objs;
...
void Gfx::draw_message(Bitmap * bitmap, const GfxMap & map, bool show){
	int total = 6;
	sg_icon_primitive_t objs[total];
	sg_icon_t icon;
	icon.elements = objs;
...
void Gfx::draw_ALPHA(Bitmap * bitmap, const GfxMap & map, bool show){
