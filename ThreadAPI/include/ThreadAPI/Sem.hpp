...
public:
   ...
   * \sa close()
   */
  Sem &open(const var::StringView &name, const OpenOptions &options);
   ...
   *
   */
  Sem &create(const var::StringView &name, int value, Exclusive exclusive);
   ...
   *
   */
  Sem &unlink(const var::StringView &name);
